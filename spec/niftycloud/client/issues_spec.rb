...
describe Niftycloud::Client do
  describe ".issues" do
    context "with project ID passed" do
      ...
      it "should return a paginated response of project's issues" do
        expect(@issues).to be_a Niftycloud::PaginatedResponse
  ...
  describe ".create_issue" do
    before do
      ...
      @issue = Niftycloud.create_issue(3, 'title')
    end
  ...
  describe ".edit_issue" do
    before do
      ...
      @issue = Niftycloud.edit_issue(3, 33, title: 'title')
    end
  ...
  describe ".close_issue" do
    before do
      stub_put("/projects/3/issues/33", "issue")
      @issue = Niftycloud.close_issue(3, 33)
    end
  ...
  describe ".reopen_issue" do
    before do
      stub_put("/projects/3/issues/33", "issue")
      @issue = Niftycloud.reopen_issue(3, 33)
    end
  ...
  describe ".delete_issue" do
    before do
      ...
      @issue = Niftycloud.delete_issue(3, 33)
    end
